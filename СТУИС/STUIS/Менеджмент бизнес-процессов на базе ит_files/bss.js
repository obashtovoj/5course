...
if (SWFPlugin > 0)
{
    ...
    document.write ('id="MovieBNS_bn_s_wantgetmore" width="190" height="400"> ');
    document.write ('<param name="movie" value="http://images.bigc.ru/bss/bn_s_wantgetmore.swf"> ');
    document.write ('<param name="quality" value="high"> ');
    document.write ('<param name="bgcolor" value="#FFFFFF"> ');
    document.write ('<embed name="MovieBNS_EMB_bn_s_wantgetmore" src="http://images.bigc.ru/bss/bn_s_wantgetmore.swf" quality="high" bgcolor="#FFFFFF" ');
